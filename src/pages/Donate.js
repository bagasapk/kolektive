      ...
      <div className="donateContainer mt-5 pb-5">
        ...
        <div className="donateEventBox mx-5 ">
          <div className="d-flex justify-content-between m-4">
            <div className=" donateEventDesc col-8 text-start">
              ...
              <p>
                ...
                scholars, practitioners from all over the world to exchange and
                share their experiences, ideas, knowledge and research results
                to the latest issues of Artificial Intelligence and Big Data.
              </p>
            </div>
          ...
          <div className="donateEventDetails text-start mx-4">
            <h4>Detail Event</h4>
            <p>
              🗣️ Pembicara : 1. Dr. H. Vitra Yozi Chaniago, S.E., M.E., Ak., CA
              (Tax Investigator) 2. Joko Supriyanto, Ak., M.Ak., CA (ex Auditor
              Pemerintah BPKP) ✒️ Moderator : Dr. Surtikanti, S.E., M.Si., Ak.,
              CA (Ketua Prodi Akuntansi S1 Unikom) ........
            </p>
          </div>
      ...
      <div className="donateContainer my-5 text-start pb-5">
        ...
        <div className="donateKolegaBox mx-5 px-4">
          ...
          <p>
            ...
            experienced speakers in fields relevant to the IFEST theme. ICAIBDA
            aims to establish a platform and to provide opportunities for
            academic scientists, researchers, research scholars, practitioners
            from all over the world to exchange and share their experiences,
            ideas, knowledge and research results to the latest issues of
